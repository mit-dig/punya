...
public class XmlConfig implements AndroidTask {
  ...
  public TaskResult execute(AndroidCompilerContext context) {
    ...
    context.getReporter().info("Creating fragment xml");
    File fragmentDir = createDir(context.getPaths().getResDir(), "layout");
    if (!this.createFragmentXml(fragmentDir)) {
      return generateError("There was an error creating the fragment xml");
    }
