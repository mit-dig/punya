...
/*  @VisibleForTesting
  ...
  private boolean writeAndroidManifest(File manifestFile) {
    ...
    try {
      ...
      if (componentTypes.contains("com.google.appinventor.components.runtime.GoogleCloudMessaging")|| componentTypes.contains("com.google.appinventor.components.runtime.PctMessaging")){
      ...
      if (componentTypes.contains("com.google.appinventor.components.runtime.GoogleMap")){
	  ...
	  if(componentTypes.contains("com.google.appinventor.components.runtime.Dropbox")){
	    out.write("<service android:name=\"com.google.appinventor.components.runtime.DropboxUploadService\"></service> \n");	    
	  }
	  if(componentTypes.contains("com.google.appinventor.components.runtime.GoogleDrive")){
	  ...
	  if(componentTypes.contains("com.google.appinventor.components.runtime.Timer")){
      ...
      if (componentTypes.contains("com.google.appinventor.components.runtime.Twitter")){
        out.write("    <activity android:name=\"" + WEBVIEW_ACTIVITY_CLASS + "\" " +
            "android:configChanges=\"orientation|keyboardHidden\" " +
            "android:screenOrientation=\"behind\">\n");
        out.write("      <intent-filter>\n");
      ...
      if (componentTypes.contains("com.google.appinventor.components.runtime.Texting")) {
  ...
  private boolean generateClasses(File classesDir) {
    try {
      ...
      String classpath =
        ...
        getResource(ANDROID_SUPPORT_V4_JAR) + COLON;
