...
import static com.google.appinventor.components.runtime.GCMConstants.DEFAULT_INTENT_SERVICE_CLASS_NAME;
...
public class GCMBroadcastReceiver extends BroadcastReceiver {
    ...
    static final String getDefaultIntentServiceClassName(Context context) {
        Log.i(TAG,"GCMBroadcastReceiverExt starts");
        String className = "com.google.appinventor.components.runtime" +DEFAULT_INTENT_SERVICE_CLASS_NAME;
        return className;
    }
}
