...
public class YaVersion {
  ...
  // - BLUETOOTH_CLIENT_COMPONENT_VERSION was incremented to 7
  // For YOUNG_ANDROID_VERSION 239:
  // - appinventor-sources master was merged into punya master
  public static final int YOUNG_ANDROID_VERSION = 239;
  ...
  public static final String PREFERRED_COMPANION = "2.65punya1";
  public static final String EMULATOR_UPDATE_URL = ""; // Should be an APK
  public static final String COMPANION_UPDATE_URL = "";
  public static final String COMPANION_UPDATE_URL1 = "";
  public static final String COMPANION_UPDATE_EMULATOR_URL = "";
  public static final String [] ACCEPTABLE_COMPANIONS = { "2.65punya1", "2.65punya1u" };
