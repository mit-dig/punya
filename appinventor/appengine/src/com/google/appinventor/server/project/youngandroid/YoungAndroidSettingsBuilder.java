...
import static com.google.appinventor.shared.settings.SettingsConstants.YOUNG_ANDROID_SETTINGS_MAPS_KEY;
...
public class YoungAndroidSettingsBuilder {
  ...
  public YoungAndroidSettingsBuilder(Settings settings) {
    ...
    mapsKey = Strings.nullToEmpty(settings.getSetting(PROJECT_YOUNG_ANDROID_SETTINGS,
        YOUNG_ANDROID_SETTINGS_MAPS_KEY));
  ...
  public YoungAndroidSettingsBuilder(Properties properties) {
    ...
    mapsKey = properties.getProperty("mapskey", "");
  ...
  public YoungAndroidSettingsBuilder setMapsKey(String mapsKey) {
  ...
  public String build() {
    ...
    object.put(YOUNG_ANDROID_SETTINGS_MAPS_KEY, mapsKey);
  ...
  public String toProperties() {
    ...
    addPropertyIfSet(result, "mapskey", mapsKey);
  ...
  public boolean equals(Object object) {
    if (object instanceof YoungAndroidSettingsBuilder) {
      ...
      result &= other.mapsKey.equals(mapsKey);
