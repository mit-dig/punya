...
public final class YoungAndroidProjectService extends CommonProjectService {
   ...
   */
  public static String getProjectSettings(String icon, String vCode, String vName, String useslocation, String mapskey, String aName) {
    ...
    return "{\"" + SettingsConstants.PROJECT_YOUNG_ANDROID_SETTINGS + "\":{" +
        ...
        "\":\"" + useslocation + "\",\"" + SettingsConstants.YOUNG_ANDROID_SETTINGS_MAPS_KEY +
        "\":\"" + mapskey + "\",\"" + SettingsConstants.YOUNG_ANDROID_SETTINGS_APP_NAME +
        "\":\"" + aName + "\"}}";
  }
  ...
  public static String getProjectPropertiesFileContents(String projectName, String qualifiedName,
    String icon, String vcode, String vname, String useslocation, String mapskey, String aname) {
  ...
  public void storeProjectSettings(String userId, long projectId, String projectSettings) {
    ...
    if (!newIcon.equals(oldIcon) || !newVCode.equals(oldVCode) || !newVName.equals(oldVName)
      ...
      String newContent = getProjectPropertiesFileContents(projectName, qualifiedName, newIcon, newVCode, newVName, newUsesLocation, newMapsKey, newAName);
  ...
  public long copyProject(String userId, long oldProjectId, String newName) {
    ...
    for (String oldSourceFileName : storageIo.getProjectSourceFiles(userId, oldProjectId)) {
      ...
      if (oldSourceFileName.equals(PROJECT_PROPERTIES_FILE_NAME)) {
        ...
        newContents = getProjectPropertiesFileContents(newName, qualifiedFormName, icon, vcode, vname, useslocation, mapskey, aname);
      } else {
    ...
    return storageIo.createProject(userId, newProject, getProjectSettings(icon, vcode, vname, useslocation, mapskey, aname));
  }
