...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Import screen (.ais) from my computer ...")
  ...
  @DefaultMessage("Export selected screen (.ais) to my computer")
  ...
  @DefaultMessage("Are you really sure you want to delete this project: {0}?"+
      " Note that the published copy of this project will be still in gallery")
  @Description("Confirmation message for selecting a single project and clicking delete when gallery is on")
  String confirmDeleteSinglePublishedProjectWarning(String projectName);
  ...
  @DefaultMessage("Are you really sure you want to delete these projects: {0}?"+
      ...
      " the gallery will be still there.")
  ...
  @Description("Confirmation message for selecting multiple projects and clicking delete when gallery is on")
  String confirmDeleteForeverManyProjectsWithGalleryOn(String projectNames);
